        ...
        <div class="col-md-12">
            ...
            <div class="card card-info" style="padding: 40px;">
                <div class="card-header" style="text-align: center;">
                    <h3 class="card-title1 " style="text-align: center;">Tinglovchi tahrirlash</h3>
                </div>
                <br>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                ...
                                <?php $group =
                                \common\models\Group::find()->where(['id' => $student->group_id, 'uni_id'=>$user1->uni_id])->one();
                                ?>
                                ...
                                <?php $faculty1 = \yii\helpers\ArrayHelper::map(\common\models\Faculty::find()
                                ->where(['uni_id'=>$user1->uni_id])->all(), 'id', 'name') ?>
                            ...
                            <div class="col-sm-4">
                                <?php $direction1 =   \yii\helpers\ArrayHelper::map(\common\models\Direction::find()->where(['faculty_id' => $faculty->id, 'uni_id'=>$user1->uni_id])->all(), 'id', 'name'); ?>
                            ...
                            <div class="col-sm-4">
                                <?php $group1 =   \yii\helpers\ArrayHelper::map(\common\models\Group::find()->where(['direction_id' => $direction->id, 'uni_id'=>$user1->uni_id])->all(), 'id', 'name'); ?>
